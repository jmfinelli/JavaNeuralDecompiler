 ...
 */
public class SourcePrinterMod {
    private final String endOfLineCharacter;
    private final String indentation;
    private final int tabWidth;
    private final PrettyPrinterConfigurationMod.IndentType indentType;
    ...
    SourcePrinterMod(final PrettyPrinterConfigurationMod configuration) {
     ...
     */
    public SourcePrinterMod indent() {
     ...
     * Does not actually output anything.
     */
    public SourcePrinterMod indentWithAlignTo(int column) {
     ...
     * Does not actually output anything.
     */
    public SourcePrinterMod unindent() {
        if (indents.isEmpty()) {
     ...
     * @see SourcePrinterMod#println(String)
     */
    public SourcePrinterMod print(final String arg) {
        if (!indented) {
     ...
     * @return this instance, for nesting calls to method as fluent interface
     */
    public SourcePrinterMod println(final String arg) {
        print(arg);
        println();
        return this;
    }
     ...
     * @return this instance, for nesting calls to method as fluent interface
     */
    public SourcePrinterMod println() {
