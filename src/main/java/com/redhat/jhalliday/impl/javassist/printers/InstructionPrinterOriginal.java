 ...
 */
public class InstructionPrinterOriginal implements Opcode {
    ...
    public InstructionPrinterOriginal(CtMethod method, String delimiter) {

        this.delimiter = (delimiter.isEmpty() ? "\n" : delimiter);
