...
public class BytecodeRepresentationImpl implements BytecodeRepresentation {
    ...
    public BytecodeRepresentationImpl(String className, MethodInfo info, String sentence){
